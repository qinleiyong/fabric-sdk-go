...
import (
	...
	calib "github.com/qinleiyong/fabric-sdk-go/internal/github.com/hyperledger/fabric-ca/lib"
	...
	caapi "github.com/qinleiyong/fabric-sdk-go/internal/github.com/hyperledger/fabric-ca/sdkinternal/pkg/api"
...
func createFabricCAClient(caID string, cryptoSuite core.CryptoSuite, config msp.IdentityConfig) (*calib.Client, error) {
	...
	c.Config.TLS.GmTlsCertPool, err = config.GMTLSCACertPool().Get()
	if err != nil {
		return nil, errors.Wrap(err, "couldn't load configured gm cert pool")
	}
